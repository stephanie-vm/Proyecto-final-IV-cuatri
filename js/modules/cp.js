...
class App {
  ...
  initUI() {
    ...
    this.controls.wave.onclick = () => {
      const i = this.controls.wave.getElementsByTagName('i')[0];
      if (this.wave) {
        i.classList.add('off');
        this.wave = false;
      } else if (!this.wave) {
    ...
    this.controls.lights.onclick = () => {
      const i = this.controls.lights.getElementsByTagName('i')[0];
      if (this.dark) {
        i.classList.remove('off');
    ...
    this.controls.play.onclick = () => {
      const i = this.controls.play.getElementsByTagName('i')[0];
    ...
    this.controls.volume.onclick = () => {
      const i = this.controls.volume.getElementsByTagName('i')[0];
  ...
  loadAudio() {
    ...
    request.onprogress = () => {
      if (request.response) this.playAudio(request.response);
    };
